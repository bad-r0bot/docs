...
* Please note that after upgrading to Mendix 5.21.9, it is only possible to upgrade to Mendix 6.10.11, which is currently the latest version of Mendix 6. To migrate to Mendix 6, use version 6.10.11.
